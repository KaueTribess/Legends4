...
### Descrição
Neste tipo, as [[Criatura|Criaturas]] envolvidas na cena de [[Sistemas/Legends 4/Cenas/Tipos/Combate|Combate]] são separadas em times. Cada time possui sua própria posição na ordem de [[Iniciativa]], mas o time que está ativo alterna conforme falhas e decisões táticas.

Diferente da [[Por Time|Iniciativa por Time]], as [[Sistemas/Legends 4/Criaturas/NPCs/Criaturas|Criaturas]] de um time não precisam ter seus turnos encerrados para que outro time se torne ativo. O turno de uma [[Criatura]] pode ser pausado e retomado dentro da mesma [[Rodada]], até que ela encerre seu próprio [[Turno]] ou fique sem [[Ações]] disponíveis.

### Quando Usar
Este é o tipo de [[Iniciativa]] recomendado para jogar Legends 4.

Use este tipo em qualquer cena de [[Sistemas/Legends 4/Cenas/Tipos/Combate|Combate]], mas principalmente naqueles com peso narrativo, ritmo dinâmico e tensão a cada rolagem importante.
...
### Resolução
No início de uma cena de [[Sistemas/Legends 4/Cenas/Tipos/Combate|Combate]], cada `Time` define uma [[Criatura]] `Representante` para realizar a rolagem de [[Iniciativa]].
...
O `Time` com maior resultado se torna o primeiro `Time Ativo`. Enquanto ativo, as [[Sistemas/Legends 4/Criaturas/NPCs/Criaturas|Criaturas]] desse `Time` podem agir usando suas [[Ações]], como [[Ação Padrão]], [[Ação de Movimento]], [[Ação Bônus]] e [[Ação Livre]].

As [[Sistemas/Legends 4/Criaturas/NPCs/Criaturas|Criaturas]] do `Time Ativo` podem agir em qualquer ordem escolhida pelos [[Jogador|Jogadores]] ou pelo [[Mestre]], dependendo de quem controla o `Time`.

Enquanto um `Time` for o `Time Ativo`, suas [[Sistemas/Legends 4/Criaturas/NPCs/Criaturas|Criaturas]] podem agir em qualquer ordem e intercalar suas [[Ações]].
...
Quando todas as [[Sistemas/Legends 4/Criaturas/NPCs/Criaturas|Criaturas]] do `Time Ativo` encerram seus [[Turno|Turnos]], ele deixa de ser um `Time Elegível` e o próximo `Time Elegível` se torna o novo `Time Ativo`.
...
Caso uma [[Criatura]] precise realizar uma rolagem no começo de seu [[Turno]], ela pode permitir que outras [[Sistemas/Legends 4/Criaturas/NPCs/Criaturas|Criaturas]] do mesmo `Time` ajam antes que ela, desde que ainda não tenha iniciado seu próprio turno.
...
Falhas em rolagens feitas como parte de [[Reação|Reações]] de [[Sistemas/Legends 4/Criaturas/NPCs/Criaturas|Criaturas]] que não pertencem ao `Time Ativo` não trocam o status dele.
...
### Exemplo
Uma cena de [[Sistemas/Legends 4/Cenas/Tipos/Combate|Combate]] possui três times: `personagens`, `esqueletos` e `bandidos`.
...
Quando os `esqueletos` encerram seus turnos, não resta nenhum `Time Elegível`. A primeira [[Rodada]] termina, todas as [[Sistemas/Legends 4/Criaturas/NPCs/Criaturas|Criaturas]] renovam suas [[Ações]] e [[Reação|Reações]], e os `personagens` se tornam o primeiro `Time Ativo` da nova [[Rodada]].