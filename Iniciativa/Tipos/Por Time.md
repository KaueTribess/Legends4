...
### Descrição
Neste tipo, as [[Criatura|Criaturas]] envolvidas na cena de [[Sistemas/Legends 4/Cenas/Tipos/Combate|Combate]] são separadas em times. Cada time possui sua própria posição na ordem de [[Iniciativa]].
...
### Exemplo
Uma cena de [[Sistemas/Legends 4/Cenas/Tipos/Combate|Combate]] possui três times: `personagens`, `bandidos` e `esqueletos`.

Cada time escolhe um `Representante` para realizar sua rolagem de [[Iniciativa]]. O representante dos `personagens` obtém o maior resultado, seguido pelos representantes dos `bandidos` e dos `esqueletos`, respectivamente.
