...
### Descrição
Neste tipo, as [[Criatura|Criaturas]] envolvidas na cena de [[Sistemas/Legends 4/Cenas/Tipos/Combate/Combate|Combate]] são separadas em times. Cada time possui sua própria posição na ordem de [[Iniciativa]].

### Quando Usar
Este tipo de [[Iniciativa]] pode ser utilizado em cenas de [[Sistemas/Legends 4/Cenas/Tipos/Combate/Combate|Combate]] rápidas ou em que a ordem dos times seja mais importante do que a ordem individual de cada criatura.
