...
A cena se transforma quando não existe mais um conflito imediato. Isso pode acontecer por derrota, rendição, cumprimento de um objetivo ou mudança das circunstâncias.

Caso um lado tente fugir e outro tente alcançá-lo, a cena se transforma em uma cena de [[Perseguição]].



### Ações de Movimento
A `Agilidade` altera a quantidade de [[Ação de Movimento|Ações de Movimento]] que uma [[Sistemas/Legends 4/Criaturas/Criaturas|Criatura]] possui em seu [[Turno]].

- **Agilidade -1:** -1 [[Ação de Movimento]].
- **Agilidade 0 a 4:** +0 [[Ação de Movimento|Ações de Movimento]].
- **Agilidade 5 a 9:** +1 [[Ação de Movimento]].
- **Agilidade 10:** +2 [[Ação de Movimento|Ações de Movimento]].